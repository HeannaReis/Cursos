 ...
 * toda segunda quinzena do mês de Julho ela e seus amigos se reunem para tradicional 
 * mandiocada! Na festiva sempre se reúnem na casa da Marlene, o Chico, o Beto, o Bernardo, 
 * a Marina e a Iara. E como não poderia ser diferente o prato principal dessa reunião é a 
 * mandioca. Cada um deles come de uma a dez porções de mandioca e eles sempre avisam a Marlene 
 * com antecedência a respeito de quantas porções irão comer nesse dia. O tamanho da porção de 
 ...
 * - A Iara come 150
 * 
 * - Marlene por sua vez sempre come 225 gramas de mandioca. Cansada de todo ano ter que calcular 
 ...
 * 
 * Entrada:
 * - A entrada consiste de 5 inteiros cada um representando as porções que os convidados de dona 
 ...
 * 
 * Saída:
 * - A saída consiste de um único inteiro que representa quanta mandioca Marlene deve preparar em 
 * gramas.
 */
