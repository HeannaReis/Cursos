 ...
 * 
 * Saída:
 * - Se uma nota inválida  for lida, deve ser impressa a 
 * mensagem "nota invalida".
 *
 * - Quando duas notas válidas forem lidas, deve ser impressa 
 * a mensagem "media = " seguido do valor do cálculo. O valor 
